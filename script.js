...
const studentname = decodeURIComponent(url.searchParams.get('name'));
const purpose = decodeURIComponent(url.searchParams.get("purpose"));
const departmentType = decodeURIComponent(url.searchParams.get("department"))
const startDate = decodeURIComponent(url.searchParams.get("start"));
const endDate = decodeURIComponent(url.searchParams.get("end"));
const certificateId = decodeURIComponent(url.searchParams.get("certificate_id"));
